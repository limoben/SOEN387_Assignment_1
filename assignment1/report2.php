		...
		<html>
		   ...
		   <body>
		      <?php
		         ...
		         // build SELECT query
		         $query = "SELECT registration.studentID, student.firstName FROM registration join student where student.ID = registration.studentID and registration.courseID = $courseID";
		         // Connect to MySQL
